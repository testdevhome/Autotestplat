...
-- ----------------------------
INSERT INTO `auth_user` VALUES ('2', 'pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=', '2023-11-13 00:26:14.325423', '0', 'fin', 'fin', '5', '13711112222', '1', '1', '2023-10-04 03:24:35.000000');
...
INSERT INTO `autotestplat_testplan` VALUES ('106', '新的测试计划', '{ online_url }', 'testplan_interface_1917_用户列表接口-设置接口返回值关联参数-通过正则表达式设置,testplan_interface_1921_用户列表接口-随机数字参数', '用户列表接口-设置接口返回值关联参数-通过正则表达式设置 ， 用户列表接口-随机数字参数', 'fin', '5', '53651');
INSERT INTO `autotestplat_testplan` VALUES ('112', 'plan', '{ online_url }', 'testplan_interface_1922_用户列表接口-随机数字参数', '用户列表接口-随机数字参数', 'fin', '5', '53655');
...
CREATE TABLE `autotestplat_testplan_interface` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1923 DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `autotestplat_testplan_interface` VALUES ('1922', '112', 'plan', '用户列表接口-随机数字参数', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', null, '', null, '1', 'fin', null, null);
...
CREATE TABLE `autotestplat_testplan_interface_order` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34643 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of autotestplat_testplan_interface_order
-- ----------------------------
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34601', '98', '1907');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34640', '106', '1917');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34641', '106', '1921');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34642', '112', '1922');
...
CREATE TABLE `autotestplat_testplan_interface_result` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27252 DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27236', '20231113082538557593', '5', '106', '1917', '用户列表接口-设置接口返回值关联参数-通过正则表达式设置', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-12T14:15:09.321Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"\\u5c0f\\u8f89\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-13 08:25:38', '定时任务', '0.030034', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27237', '20231113082538557593', '5', '106', '1921', '用户列表接口-随机数字参数', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'34345825262\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-12T14:15:09.321Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"\\u5c0f\\u8f89\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-13 08:25:38', '定时任务', '0.02999', '100%');
...
) ENGINE=InnoDB AUTO_INCREMENT=53656 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of djcelery_periodictask
-- ----------------------------
INSERT INTO `djcelery_periodictask` VALUES ('53624', 'celery.backend_cleanup', 'celery.backend_cleanup', '[]', '{}', null, null, null, null, '1', null, '0', '2023-11-13 01:07:07', '', '4', null);
...
INSERT INTO `djcelery_periodictask` VALUES ('53651', '106', 'autotest.views_interfacetestplan.api_autotest_task', '[106]', '{}', null, null, null, null, '1', '2023-11-13 01:07:07', '21', '2023-11-13 01:07:07', 'fin', null, '5');
INSERT INTO `djcelery_periodictask` VALUES ('53655', '112', 'autotest.views_interfacetestplan.api_autotest_task', '[112]', '{}', null, null, null, null, '1', null, '0', '2023-11-13 01:07:41', 'fin', null, '5');
...
-- ----------------------------
INSERT INTO `djcelery_periodictasks` VALUES ('1', '2023-11-13 01:07:41');
