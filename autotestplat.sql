...
-- ----------------------------
INSERT INTO `auth_user` VALUES ('2', 'pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=', '2023-12-03 09:29:04.198247', '0', 'fin', 'fin', '5', '13711112221', '1', '1', '2023-10-04 03:24:35.000000');
INSERT INTO `auth_user` VALUES ('4', 'pbkdf2_sha256$120000$Sy6uDO27Dtfg$XOZvLV0DLAC0QXtZ1tgnTj+EYzMYvFiegv96plk9EbQ=', '2023-12-01 15:25:52.449071', '0', 'test', '', '3', '13800001111', '1', '1', '2023-10-13 06:23:00.000000');
INSERT INTO `auth_user` VALUES ('7', 'pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=', '2023-11-30 07:03:02.557912', '1', 'root', '', '5', '13822223333', '1', '1', '2023-11-06 00:00:00.000000');
INSERT INTO `auth_user` VALUES ('8', 'pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=', '2023-11-06 13:21:22.269930', '1', 'admin', '', '5', '13822223333', '1', '1', '2023-11-06 00:00:00.000000');
...
-- ----------------------------
INSERT INTO `autotestplat_interface_testcase` VALUES ('1338', '用户列表接口-断言错误校验', '{ test_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{}', 'JSON', 'post', 'fin', null, '3', '', null, null, '1', '20012');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1351', '用户列表接口-获取前面接口返回值参数的值', '{ test_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{keyres}\"}', 'JSON', 'post', 'fin', null, '3', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1363', '用户列表接口-参数中获取随机变量参数值', '{ test_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{timeRandom}\"}', 'JSON', 'post', 'fin', null, '3', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1383', '用户列表接口-设置接口返回值关联参数-通过正则表达式设置', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1392', '用户列表接口-参数中获取随机变量参数值', '{ test_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{timeRandom}\"}', 'JSON', 'post', 'fin', null, '3', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1396', '用户列表接口-设置接口返回值关联参数-通过正则表达式设置2', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"\"}', 'JSON', 'post', 'test', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1399', '用户列表接口-随机数字参数', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1400', '用户列表接口-随机数字参数2modify', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1401', '用户列表接口-随机数字参数3modify', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1402', '用户列表接口-随机数字参数4mod', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1403', '用户列表接口-随机数字参数5', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin1');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1404', '用户列表接口-随机数字参数6', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1405', '用户列表接口-随机数字参数7', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1406', '用户列表接口-随机数字参数8', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1407', '用户列表接口-随机数字参数9', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1408', '用户列表接口-随机数字参数10', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1409', '用户列表接口-随机数字参数11', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1410', '用户列表接口-随机数字参数12', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1411', '用户列表接口-随机数字参数13', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1412', '用户列表接口-随机数字参数14', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1414', '用户列表接口-随机数字参数15', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1415', '用户列表接口-随机数字参数16', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1416', '用户列表接口-随机数字参数17', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1417', '用户列表接口-随机数字参数18', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1418', '用户列表接口-随机数字参数19', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1419', '用户列表接口-随机数字参数20', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1420', '用户列表接口-随机数字参数21', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1421', '用户列表接口-随机数字参数22', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1422', '用户列表接口-随机数字参数23', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1423', '用户列表接口-随机数字参数24', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1424', '用户列表接口-随机数字参数25', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1425', '用户列表接口-随机数字参数26', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1426', '用户列表接口-随机数字参数27', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1427', '用户列表接口-随机数字参数28', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1428', '用户列表接口-随机数字参数29', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1429', '用户列表接口-随机数字参数30', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1430', '用户列表接口-随机数字参数31', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1431', '用户列表接口-随机数字参数32', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1432', '用户列表接口-随机数字参数33', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1433', '用户列表接口-随机数字参数34', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1434', '用户列表接口-随机数字参数35', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\r\n        \"username\": \"{numRandom}\"\r\n}', 'JSON', 'get', 'fin', null, '5', null, '', '', '1', 'fin1');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1435', '用户列表接口-随机数字参数36', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1436', '用户列表接口-随机数字参数37', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1437', '用户列表接口-随机数字参数38', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\":\"\", \"Content-Type\":\"application/json; charset=utf-8\", \"Cookie\": \"\",\"token\":\"{token}\"}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1438', '用户列表接口-随机数字参数39', '{ online_url }', '/autotest/user/getTableData/', '{\"Accept\": \"1\", \"Content-Type\": \"application/json; charset=utf-8\", \"Cookie\": \"2\", \"token\": \"{token}\"}', '{\r\n        \"token\": \"{token}\",\r\n        \"username\": \"{numRandom}\"\r\n}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1439', '用户列表接口-随机数字参数40', '{ online_url }', '/autotest/user/getTableData/', '{\"token\": \"1\"}', '{}', 'FORM', 'get', 'fin', null, '5', null, '', '', '1', 'fin');
...
INSERT INTO `autotestplat_parameter` VALUES ('951', 'baidu', 'baidu', 'https://www.baidu.com/', null, null, null, '5', null, 'env');
INSERT INTO `autotestplat_parameter` VALUES ('1000', '2', 'token', '', '1', '1', '0', '5', '1439', 'res');
INSERT INTO `autotestplat_parameter` VALUES ('1001', '2', '2', '', '2', '2', '1', '5', '1439', 'res');
...
CREATE TABLE `autotestplat_testplan_interface_order` (
  ...
  `interface_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35270 DEFAULT CHARSET=utf8;
...
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35228', '131', '1995');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35229', '131', '1996');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35230', '131', '1997');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35231', '131', '1998');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35232', '131', '1999');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35233', '131', '2000');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35234', '131', '2001');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35235', '131', '2002');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35236', '131', '2003');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35237', '131', '2004');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35238', '131', '2005');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35239', '131', '2006');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35240', '131', '2007');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35241', '131', '2008');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35242', '131', '2009');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35243', '131', '2010');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35244', '131', '2011');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35245', '131', '2012');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35246', '131', '2013');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35247', '131', '2014');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35248', '131', '2015');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35249', '131', '2016');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35250', '131', '2017');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35251', '131', '2018');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35252', '131', '2019');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35253', '131', '2020');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35254', '131', '2021');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35255', '131', '2022');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35256', '131', '2023');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35257', '131', '2024');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35258', '131', '2025');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35259', '131', '2026');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35260', '131', '2027');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35261', '131', '2028');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35262', '131', '2029');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35263', '131', '2030');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35264', '131', '2031');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35265', '131', '2032');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35266', '131', '2033');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35267', '131', '2034');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35268', '131', '2035');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35269', '131', '2036');
...
-- ----------------------------
INSERT INTO `django_session` VALUES ('04b73vk9ulwlehodx1o3z8fw7u0f3fem', '', '2023-12-15 03:46:17.779023');
INSERT INTO `django_session` VALUES ('09c5p0c9tu066yc9me3lxkqrgdjeh2qm', '', '2023-12-16 11:06:58.264912');
...
INSERT INTO `django_session` VALUES ('1uuadxjdcy06zz7us7wvi6sodtazlted', '', '2023-12-17 08:57:28.066830');
INSERT INTO `django_session` VALUES ('20edx6b0r9iosyywv5db28ueebcd04q6', '', '2023-12-16 05:09:30.797078');
...
INSERT INTO `django_session` VALUES ('2s4ucd5pwpl52xti9o7nlbcmrdp04t11', '', '2023-12-16 06:52:30.339700');
...
INSERT INTO `django_session` VALUES ('5npcneuoivopa0rl5jpwzijs5vdq63u3', '', '2023-12-17 08:44:04.795763');
...
INSERT INTO `django_session` VALUES ('8grvsbi8p5tb261tjwakg9c9unafrnyp', '', '2023-12-16 04:58:19.450064');
...
INSERT INTO `django_session` VALUES ('aqq2dn6e6uzgd2s11yyuershk0lf3u42', '', '2023-12-16 06:56:13.210661');
...
INSERT INTO `django_session` VALUES ('boi7886qo4303ypp2wabbgfmfkici9ve', '', '2023-12-17 09:29:04.198247');
...
INSERT INTO `django_session` VALUES ('btso6n6uuthtii4bsrvs30cvncb2e78t', '', '2023-12-17 06:39:37.614482');
INSERT INTO `django_session` VALUES ('btzrje3poag2111jv08fnprv786o75np', '', '2023-12-16 04:51:36.813195');
INSERT INTO `django_session` VALUES ('c1avvsjmdw89anh2ybzighf0yzkns4gd', '', '2023-12-17 06:07:03.654851');
...
INSERT INTO `django_session` VALUES ('e04vd77tck041nxr57i2sq2z8mybb36i', '', '2023-12-17 05:13:21.335220');
...
INSERT INTO `django_session` VALUES ('g19yoiovnfyw61u4jd4ofon7d1x50ole', '', '2023-12-17 09:23:50.744896');
...
INSERT INTO `django_session` VALUES ('hfu7e36x8fgy04mvkcw1zrntlgtxojt3', '', '2023-12-17 09:19:35.805579');
...
INSERT INTO `django_session` VALUES ('jekvhwc9kuyxq2huf7e6spix402gbhxa', '', '2023-12-17 06:14:31.833650');
...
INSERT INTO `django_session` VALUES ('lb9gw1dnc7qgu60lpzhzljlwg36juyvg', '', '2023-12-14 03:43:27.595186');
...
INSERT INTO `django_session` VALUES ('nncpte0hcq3vajm2ymus8npabsch11xg', '', '2023-12-16 05:15:11.713295');
...
INSERT INTO `django_session` VALUES ('othrytm9k9unq97yzp1whqmsiz0qxm3c', '', '2023-12-16 11:50:44.749034');
...
INSERT INTO `django_session` VALUES ('qg2dy8na5l3gnlzzwufs7xxpaje7d7p5', '', '2023-12-16 01:19:49.295988');
...
INSERT INTO `django_session` VALUES ('qwwp84fttpk6zlgnefh2ggzzyrjpo3mb', '', '2023-12-17 05:14:49.464509');
...
INSERT INTO `django_session` VALUES ('si6qv0uyajvfj41ufdgev0uv9cxcg5mz', '', '2023-12-17 02:13:26.055070');
...
INSERT INTO `django_session` VALUES ('sribbtx7q2q59rhq79qget5yxvxul7vj', '', '2023-12-14 07:04:31.797967');
...
INSERT INTO `django_session` VALUES ('ubyy5fvq4r25nwyorsqfqp2ztcfo5mym', '', '2023-12-17 05:04:21.184143');
INSERT INTO `django_session` VALUES ('ux6yig9xgdhhmo6d9yb8kwo7cq82qr4m', '', '2023-12-16 05:12:01.537018');
...
INSERT INTO `django_session` VALUES ('vqq8g8jnezm2t1bxiwywto34rop211fe', '', '2023-12-16 06:41:39.463596');
...
INSERT INTO `django_session` VALUES ('whit3dmbiiv7umclv4qw6wrr1tjbwots', '', '2023-12-15 15:12:24.869637');
...
INSERT INTO `django_session` VALUES ('zn01khauzw4ih7zs49zzvdyuvjovdc64', '', '2023-12-17 07:41:01.001799');
...
INSERT INTO `djcelery_crontabschedule` VALUES ('97', '02', '11', '*', '25', '11');
