...
-- ----------------------------
INSERT INTO `auth_user` VALUES ('2', 'pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=', '2023-11-22 11:14:05.225553', '0', 'fin', 'fin', '5', '13711112222', '1', '1', '2023-10-04 03:24:35.000000');
...
INSERT INTO `autotestplat_interface_testcase` VALUES ('1402', '用户列表接口-随机数字参数4modify', '{ online_url }', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
...
INSERT INTO `autotestplat_parameter` VALUES ('898', '1', '1', '', '1', '1', '0', 'testplan', '1967', 'res');
...
INSERT INTO `autotestplat_testplan` VALUES ('114', '测试计划', '{ online_url }', 'testplan_interface_1928_用户列表接口-设置接口返回值关联参数-通过正则表达式设置,testplan_interface_1930_用户列表接口-随机数字参数,testplan_interface_1931_用户列表接口-随机数字参数2,testplan_interface_1932_用户列表接口-随机数字参数3,testplan_interface_1933_用户列表接口-随机数字参数4,testplan_interface_1934_用户列表接口-随机数字参数5,testplan_interface_1935_用户列表接口-随机数字参数,testplan_interface_1936_用户列表接口-随机数字参数', '用户列表接口-设置接口返回值关联参数-通过正则表达式设置 ， 用户列表接口-随机数字参数 ， 用户列表接口-随机数字参数2 ， 用户列表接口-随机数字参数3 ， 用户列表接口-随机数字参数4 ， 用户列表接口-随机数字参数5 ， 用户列表接口-随机数字参数 ， 用户列表接口-随机数字参数', 'fin', '5', '53657');
INSERT INTO `autotestplat_testplan` VALUES ('128', 'plan', '{ online_url }', 'testplan_interface_1965_用户列表接口-随机数字参数', '用户列表接口-随机数字参数', 'fin', '5', '53673');
INSERT INTO `autotestplat_testplan` VALUES ('129', '2.1版本测试任务计划', '{ online_url }', 'testplan_interface_1966_用户列表接口-设置接口返回值关联参数-通过正则表达式设置,testplan_interface_1967_用户列表接口-设置接口返回值关联参数-通过正则表达式设置2,testplan_interface_1968_用户列表接口-随机数字参数,testplan_interface_1969_用户列表接口-随机数字参数2,testplan_interface_1970_用户列表接口-随机数字参数3,testplan_interface_1971_用户列表接口-随机数字参数4,testplan_interface_1972_用户列表接口-随机数字参数5,testplan_interface_1973_用户列表接口-随机数字参数6,testplan_interface_1974_用户列表接口-随机数字参数7,testplan_interface_1975_用户列表接口-随机数字参数8', '用户列表接口-设置接口返回值关联参数-通过正则表达式设置 ，用户列表接口-设置接口返回值关联参数-通过正则表达式设置2 ，用户列表接口-随机数字参数 ，用户列表接口-随机数字参数2 ，用户列表接口-随机数字参数3 ，用户列表接口-随机数字参数4 ，用户列表接口-随机数字参数5 ，用户列表接口-随机数字参数6 ，用户列表接口-随机数字参数7 ，用户列表接口-随机数字参数8', 'fin', '5', '53674');
...
CREATE TABLE `autotestplat_testplan_interface` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1976 DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `autotestplat_testplan_interface` VALUES ('1966', '129', '2.1版本测试任务计划', '1383', '用户列表接口-设置接口返回值关联参数-通过正则表达式设置', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"\"}', 'JSON', 'post', null, '', null, '1', 'fin', null, null);
INSERT INTO `autotestplat_testplan_interface` VALUES ('1967', '129', '2.1版本测试任务计划', '1396', '用户列表接口-设置接口返回值关联参数-通过正则表达式设置2', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"\"}', 'JSON', 'post', null, '', null, '1', 'fin', null, null);
INSERT INTO `autotestplat_testplan_interface` VALUES ('1968', '129', '2.1版本测试任务计划', '1399', '用户列表接口-随机数字参数', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', null, '', null, '1', 'fin', null, null);
INSERT INTO `autotestplat_testplan_interface` VALUES ('1969', '129', '2.1版本测试任务计划', '1400', '用户列表接口-随机数字参数2modify', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', null, '', null, '1', 'fin', null, null);
INSERT INTO `autotestplat_testplan_interface` VALUES ('1970', '129', '2.1版本测试任务计划', '1401', '用户列表接口-随机数字参数3', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', null, '', null, '1', 'fin', null, null);
...
INSERT INTO `autotestplat_testplan_interface` VALUES ('1972', '129', '2.1版本测试任务计划', '1403', '用户列表接口-随机数字参数5', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'1\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', null, '', null, '1', 'fin', null, null);
INSERT INTO `autotestplat_testplan_interface` VALUES ('1973', '129', '2.1版本测试任务计划', '1404', '用户列表接口-随机数字参数6', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', null, '', null, '1', 'fin', null, null);
INSERT INTO `autotestplat_testplan_interface` VALUES ('1974', '129', '2.1版本测试任务计划', '1405', '用户列表接口-随机数字参数7', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', null, '', null, '1', 'fin', null, null);
INSERT INTO `autotestplat_testplan_interface` VALUES ('1975', '129', '2.1版本测试任务计划', '1406', '用户列表接口-随机数字参数8', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', null, '', null, '1', 'fin', null, null);
...
CREATE TABLE `autotestplat_testplan_interface_order` (
  ...
  `interface_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34741 DEFAULT CHARSET=utf8;
...
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34720', '114', '1928');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34721', '114', '1930');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34722', '114', '1931');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34723', '114', '1932');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34724', '114', '1933');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34725', '114', '1934');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34726', '114', '1935');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34727', '114', '1936');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34730', '128', '1965');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34731', '129', '1966');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34732', '129', '1967');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34733', '129', '1968');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34734', '129', '1969');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34735', '129', '1970');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34736', '129', '1971');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34737', '129', '1972');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34738', '129', '1973');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34739', '129', '1974');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('34740', '129', '1975');
...
CREATE TABLE `autotestplat_testplan_interface_result` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27424 DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27334', '20231120104904973161', '5', 'Autotestplat', '114', '测试计划', '1928', '用户列表接口-设置接口返回值关联参数-通过正则表达式设置', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-20T00:50:05.596Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-20 10:49:04', '定时任务', '0.079971', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27335', '20231120104904973161', '5', 'Autotestplat', '114', '测试计划', '1930', '用户列表接口-随机数字参数', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'67117428145\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-20T00:50:05.596Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-20 10:49:04', '定时任务', '0.019993', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27336', '20231120104904973161', '5', 'Autotestplat', '114', '测试计划', '1931', '用户列表接口-随机数字参数2', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'53112892022\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-20T00:50:05.596Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-20 10:49:04', '定时任务', '0.029993', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27337', '20231120104904973161', '5', 'Autotestplat', '114', '测试计划', '1932', '用户列表接口-随机数字参数3', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'39717383347\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-20T00:50:05.596Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-20 10:49:04', '定时任务', '0.020028', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27338', '20231120104904973161', '5', 'Autotestplat', '114', '测试计划', '1933', '用户列表接口-随机数字参数4', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'95978490726\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-20T00:50:05.596Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-20 10:49:04', '定时任务', '0.02999', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27339', '20231120104904973161', '5', 'Autotestplat', '114', '测试计划', '1934', '用户列表接口-随机数字参数5', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'86287807062\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-20T00:50:05.596Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-20 10:49:04', '定时任务', '0.029998', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27340', '20231120104904973161', '5', 'Autotestplat', '114', '测试计划', '1935', '用户列表接口-随机数字参数', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'25775571931\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-20T00:50:05.596Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-20 10:49:04', '定时任务', '0.02997', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27341', '20231120104904973161', '5', 'Autotestplat', '114', '测试计划', '1936', '用户列表接口-随机数字参数', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'93459763073\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-20T00:50:05.596Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-20 10:49:04', '定时任务', '0.019994', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27342', '20231120175116235041', '5', 'Autotestplat', '127', '新的测试计划', '1964', '用户列表接口-随机数字参数15', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'42283918827\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-20T00:50:05.596Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-20 17:51:16', '定时任务', '0.030022', '100%');
...
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27351', '20231122102801955171', '5', 'Autotestplat', '114', '测试计划', '1928', '用户列表接口-设置接口返回值关联参数-通过正则表达式设置', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 10:28:01', '定时任务', '0.026386', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27352', '20231122102801955171', '5', 'Autotestplat', '114', '测试计划', '1930', '用户列表接口-随机数字参数', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'65072096513\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 10:28:01', '定时任务', '0.029989', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27353', '20231122102801955171', '5', 'Autotestplat', '114', '测试计划', '1931', '用户列表接口-随机数字参数2', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'24204323260\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 10:28:01', '定时任务', '0.03199', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27354', '20231122102801955171', '5', 'Autotestplat', '114', '测试计划', '1932', '用户列表接口-随机数字参数3', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'74616804895\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 10:28:01', '定时任务', '0.023427', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27355', '20231122102801955171', '5', 'Autotestplat', '114', '测试计划', '1933', '用户列表接口-随机数字参数44', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'92526934883\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 10:28:01', '定时任务', '0.029989', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27356', '20231122102801955171', '5', 'Autotestplat', '114', '测试计划', '1934', '用户列表接口-随机数字参数55', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'84324029491\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 10:28:01', '定时任务', '0.02999', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27357', '20231122102801955171', '5', 'Autotestplat', '114', '测试计划', '1935', '用户列表接口-随机数字参数', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'18774984569\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 10:28:01', '定时任务', '0.019992', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27358', '20231122102801955171', '5', 'Autotestplat', '114', '测试计划', '1936', '用户列表接口-随机数字参数', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'5875929791\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 10:28:01', '定时任务', '0.02999', '100%');
...
) ENGINE=InnoDB AUTO_INCREMENT=53675 DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `djcelery_periodictasks` VALUES ('1', '2023-11-22 05:35:07');
