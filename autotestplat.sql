...
-- ----------------------------
INSERT INTO `auth_user` VALUES ('2', 'pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=', '2023-11-25 12:09:53.028460', '0', 'fin', 'fin', '5', '13711112222', '1', '1', '2023-10-04 03:24:35.000000');
...
INSERT INTO `autotestplat_interface_testcase` VALUES ('1400', '用户列表接口-随机数字参数2mod', '{ online_url }', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
INSERT INTO `autotestplat_interface_testcase` VALUES ('1401', '用户列表接口-随机数字参数3mod', '{ online_url }', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
...
INSERT INTO `autotestplat_interface_testcase` VALUES ('1434', '用户列表接口-随机数字参数35', '{ online_url }', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
...
INSERT INTO `autotestplat_interface_testcase` VALUES ('1439', '用户列表接口-随机数字参数40', '{ online_url }', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', 'fin', null, '5', null, '', '', '1', 'fin');
...
INSERT INTO `autotestplat_testplan` VALUES ('128', 'plan', '{ online_url }', 'testplan_interface_1965_用户列表接口-随机数字参数,testplan_interface_1977_用户列表接口-随机数字参数', '用户列表接口-随机数字参数 ， 用户列表接口-随机数字参数', 'fin', '5', '53673', null, '2', '');
...
INSERT INTO `autotestplat_testplan_interface` VALUES ('1983', '130', '2.1testplan', '1401', '用户列表接口-随机数字参数3modify', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', null, '', null, '1', 'fin', null, null);
...
INSERT INTO `autotestplat_testplan_interface` VALUES ('1999', '131', '2.2版本测试计划', '1401', '用户列表接口-随机数字参数3modify', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', null, '', null, '1', 'fin', null, null);
INSERT INTO `autotestplat_testplan_interface` VALUES ('2000', '131', '2.2版本测试计划', '1402', '用户列表接口-随机数字参数4modify', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', null, '', null, '1', 'fin', null, null);
...
CREATE TABLE `autotestplat_testplan_interface_order` (
  ...
  `interface_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35182 DEFAULT CHARSET=utf8;
...
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35035', '128', '1965');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35036', '128', '1977');
...
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35045', '131', '1995');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35046', '131', '1996');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35047', '131', '1997');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35048', '131', '1998');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35049', '131', '1999');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35050', '131', '2000');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35051', '131', '2001');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35052', '131', '2002');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35053', '131', '2003');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35054', '131', '2004');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35055', '131', '2005');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35056', '131', '2006');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35057', '131', '2007');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35058', '131', '2008');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35059', '131', '2009');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35060', '131', '2010');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35061', '131', '2011');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35062', '131', '2012');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35063', '131', '2013');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35064', '131', '2014');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35065', '131', '2015');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35066', '131', '2016');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35067', '131', '2017');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35068', '131', '2018');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35069', '131', '2019');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35070', '131', '2020');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35071', '131', '2021');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35072', '131', '2022');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35073', '131', '2023');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35074', '131', '2024');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35075', '131', '2025');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35076', '131', '2026');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35077', '131', '2027');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35078', '131', '2028');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35079', '131', '2029');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35080', '131', '2030');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35081', '131', '2031');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35082', '131', '2032');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35083', '131', '2033');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35084', '131', '2034');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35085', '131', '2035');
INSERT INTO `autotestplat_testplan_interface_order` VALUES ('35086', '131', '2036');
...
CREATE TABLE `autotestplat_testplan_interface_result` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29622 DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27327', '20231119144413031873', '5', 'Autotestplat', '114', '测试计划', '1928', '用户列表接口-设置接口返回值关联参数-通过正则表达式设置', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-19T06:31:20.835Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"\\u5c0f\\u8f89\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-19 14:44:13', '定时任务', '0.027614', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27328', '20231119144413031873', '5', 'Autotestplat', '114', '测试计划', '1929', '用户列表接口-设置接口返回值关联参数-通过正则表达式设置2', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-19T06:31:20.835Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"\\u5c0f\\u8f89\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-19 14:44:13', '定时任务', '0.020032', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27329', '20231119144413031873', '5', 'Autotestplat', '114', '测试计划', '1930', '用户列表接口-随机数字参数', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'67576281745\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-19T06:31:20.835Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"\\u5c0f\\u8f89\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-19 14:44:13', '定时任务', '0.019995', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27330', '20231119144413031873', '5', 'Autotestplat', '114', '测试计划', '1931', '用户列表接口-随机数字参数2', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'99671751541\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-19T06:31:20.835Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"\\u5c0f\\u8f89\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-19 14:44:13', '定时任务', '0.02999', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27331', '20231119144413031873', '5', 'Autotestplat', '114', '测试计划', '1932', '用户列表接口-随机数字参数3', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'68485562193\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-19T06:31:20.835Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"\\u5c0f\\u8f89\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-19 14:44:13', '定时任务', '0.019994', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27332', '20231119144413031873', '5', 'Autotestplat', '114', '测试计划', '1933', '用户列表接口-随机数字参数4', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'4057290524\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-19T06:31:20.835Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"\\u5c0f\\u8f89\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-19 14:44:13', '定时任务', '0.019993', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27333', '20231119144413031873', '5', 'Autotestplat', '114', '测试计划', '1934', '用户列表接口-随机数字参数5', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'22653792872\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-19T06:31:20.835Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"\\u5c0f\\u8f89\", \"\", \"ChatGPT\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-19 14:44:13', '定时任务', '0.019994', '100%');
...
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27399', '20231122133904332377', '5', 'Autotestplat', '129', '2.1版本测试任务计划', '1966', '用户列表接口-设置接口返回值关联参数-通过正则表达式设置', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 13:39:04', '定时任务', '0.039001', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27400', '20231122133904332377', '5', 'Autotestplat', '129', '2.1版本测试任务计划', '1967', '用户列表接口-设置接口返回值关联参数-通过正则表达式设置2', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 13:39:04', '定时任务', '0.036264', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27401', '20231122133904332377', '5', 'Autotestplat', '129', '2.1版本测试任务计划', '1968', '用户列表接口-随机数字参数', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'49603078116\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 13:39:04', '定时任务', '0.039991', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27402', '20231122133904332377', '5', 'Autotestplat', '129', '2.1版本测试任务计划', '1969', '用户列表接口-随机数字参数2', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'1957730122\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 13:39:04', '定时任务', '0.05998', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27403', '20231122133904332377', '5', 'Autotestplat', '129', '2.1版本测试任务计划', '1970', '用户列表接口-随机数字参数3', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'13433075769\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 13:39:04', '定时任务', '0.019994', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27404', '20231122133904332377', '5', 'Autotestplat', '129', '2.1版本测试任务计划', '1971', '用户列表接口-随机数字参数4', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'65926671225\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 13:39:04', '定时任务', '0.019993', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27405', '20231122133904332377', '5', 'Autotestplat', '129', '2.1版本测试任务计划', '1972', '用户列表接口-随机数字参数5', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'42708556735\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 13:39:04', '定时任务', '0.019994', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27406', '20231122133904332377', '5', 'Autotestplat', '129', '2.1版本测试任务计划', '1973', '用户列表接口-随机数字参数6', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'1387879564\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 13:39:04', '定时任务', '0.029999', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27407', '20231122133904332377', '5', 'Autotestplat', '129', '2.1版本测试任务计划', '1974', '用户列表接口-随机数字参数7', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'60321476923\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 13:39:04', '定时任务', '0.039981', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27408', '20231122133904332377', '5', 'Autotestplat', '129', '2.1版本测试任务计划', '1975', '用户列表接口-随机数字参数8', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'77631469107\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-22T00:17:51.883Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"Autotestplat\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-22 13:39:04', '定时任务', '0.029989', '100%');
...
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27555', '20231123220700952624', '5', 'Autotestplat', '129', '2.1版本测试任务计划', '1969', '用户列表接口-随机数字参数2modify', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'49652381199\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:06:13.660Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:07:00', '定时任务', '0.026069', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27556', '20231123220700952624', '5', 'Autotestplat', '129', '2.1版本测试任务计划', '1970', '用户列表接口-随机数字参数3', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'58213754744\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:06:13.660Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:07:00', '定时任务', '0.019992', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27557', '20231123220700952624', '5', 'Autotestplat', '129', '2.1版本测试任务计划', '1971', '用户列表接口-随机数字参数4', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'15655289680\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:06:13.660Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:07:00', '定时任务', '0.019994', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27558', '20231123220700952624', '5', 'Autotestplat', '129', '2.1版本测试任务计划', '1972', '用户列表接口-随机数字参数5', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'38837086413\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:06:13.660Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:07:00', '定时任务', '0.025489', '100%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27765', '20231123224333815656', '5', 'Autotestplat', '130', '2.1testplan', '1979', '用户列表接口-设置接口返回值关联参数-通过正则表达式设置', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:28:47.303Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:43:33', '定时任务', '0.041862', '94%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27766', '20231123224333815656', '5', 'Autotestplat', '130', '2.1testplan', '1980', '用户列表接口-设置接口返回值关联参数-通过正则表达式设置2', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:28:47.303Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:43:33', '定时任务', '0.034885', '94%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27767', '20231123224333815656', '5', 'Autotestplat', '130', '2.1testplan', '1981', '用户列表接口-随机数字参数', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'96636833628\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:28:47.303Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:43:33', '定时任务', '0.039988', '94%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27768', '20231123224333815656', '5', 'Autotestplat', '130', '2.1testplan', '1982', '用户列表接口-随机数字参数2modify', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'71553274549\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:28:47.303Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:43:33', '定时任务', '0.02999', '94%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27769', '20231123224333815656', '5', 'Autotestplat', '130', '2.1testplan', '1983', '用户列表接口-随机数字参数3modify', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'48299238700\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:28:47.303Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:43:33', '定时任务', '0.029989', '94%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27770', '20231123224333815656', '5', 'Autotestplat', '130', '2.1testplan', '1984', '用户列表接口-随机数字参数4modify', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'99128888883\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:28:47.303Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:43:33', '定时任务', '0.029993', '94%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27771', '20231123224333815656', '5', 'Autotestplat', '130', '2.1testplan', '1985', '用户列表接口-随机数字参数5', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'78571873271\'}', 'post', 'fin1', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:28:47.303Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '1', '2023-11-23 22:43:33', '定时任务', '0.029989', '94%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27772', '20231123224333815656', '5', 'Autotestplat', '130', '2.1testplan', '1986', '用户列表接口-随机数字参数6', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'25631346911\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:28:47.303Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:43:33', '定时任务', '0.039986', '94%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27773', '20231123224333815656', '5', 'Autotestplat', '130', '2.1testplan', '1987', '用户列表接口-随机数字参数7', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'39010801070\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:28:47.303Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:43:33', '定时任务', '0.029988', '94%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27774', '20231123224333815656', '5', 'Autotestplat', '130', '2.1testplan', '1988', '用户列表接口-随机数字参数8', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'83321531231\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:28:47.303Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:43:33', '定时任务', '0.029992', '94%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27775', '20231123224333815656', '5', 'Autotestplat', '130', '2.1testplan', '1989', '用户列表接口-随机数字参数9', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'34860764919\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:28:47.303Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:43:33', '定时任务', '0.039989', '94%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27776', '20231123224333815656', '5', 'Autotestplat', '130', '2.1testplan', '1990', '用户列表接口-随机数字参数10', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'97621427654\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:28:47.303Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:43:33', '定时任务', '0.039985', '94%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27777', '20231123224333815656', '5', 'Autotestplat', '130', '2.1testplan', '1991', '用户列表接口-随机数字参数11', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'9435937223\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:28:47.303Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:43:33', '定时任务', '0.03999', '94%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27778', '20231123224333815656', '5', 'Autotestplat', '130', '2.1testplan', '1992', '用户列表接口-随机数字参数12', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'43706600596\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:28:47.303Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:43:33', '定时任务', '0.029997', '94%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27779', '20231123224333815656', '5', 'Autotestplat', '130', '2.1testplan', '1993', '用户列表接口-随机数字参数13', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'72303613891\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:28:47.303Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:43:33', '定时任务', '0.039987', '94%');
INSERT INTO `autotestplat_testplan_interface_result` VALUES ('27780', '20231123224333815656', '5', 'Autotestplat', '130', '2.1testplan', '1994', '用户列表接口-随机数字参数14', 'http://127.0.0.1/autotest/user/getTableData/', '{\'username\': \'13053919531\'}', 'post', 'fin', '{\"data\": [[2, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-23T14:28:47.303Z\", 0, \"fin\", \"fin\", \"Autotestplat\", \"13711112222\", 1, 1, \"2023-10-04T03:24:35Z\"], [4, \"pbkdf2_sha256$120000$Bo7j96h6jq13$slzU7IA+X92nVN2HS3eCfDR72PFeQMOFO2etdUEtLGI=\", \"2023-11-10T03:06:26.754Z\", 0, \"test\", \"\", \"ChatGPT\", \"13800001111\", 1, 1, \"2023-10-13T06:23:00Z\"], [7, \"pbkdf2_sha256$120000$5gxslwxrcPYl$Dnk4wwqVsLXN0Hgcbc+W+EqECZB+THuwRcxoSfs9bzU=\", \"2023-11-11T23:38:23.910Z\", 1, \"root\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"], [8, \"pbkdf2_sha256$120000$hWrOMJTGZ9XP$7zz48zsB2k66Dehhxgna5lQiCVw9PHs7Kvb2wbgClvU=\", \"2023-11-06T13:21:22.269Z\", 1, \"auto\", \"\", \"Autotestplat\", \"13822223333\", 1, 1, \"2023-11-06T00:00:00Z\"]]}', '0', '2023-11-23 22:43:33', '定时任务', '0.049982', '94%');
...
) ENGINE=InnoDB AUTO_INCREMENT=53679 DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `djcelery_periodictasks` VALUES ('1', '2023-11-25 11:57:13');
