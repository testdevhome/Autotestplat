...
INSERT INTO `autotestplat_interface_testcase` VALUES ('1439', '用户列表接口-随机数字参数40', '{ online_url }', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'get', 'fin', null, '5', null, '', '', '1', 'fin');
...
CREATE TABLE `autotestplat_testplan_interface` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2088 DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `autotestplat_testplan_interface` VALUES ('1998', '131', '2.2版本测试计划', '1400', '用户列表接口-随机数字参数2mod', '/autotest/user/getTableData/', '{\'Accept\': \'\', \'Content-Type\': \'application/json; charset=utf-8\', \'Cookie\': \'\'}', '{\"username\": \"{numRandom}\"}', 'JSON', 'post', null, '', null, '1', 'fin', null, null);
