...
urlpatterns = [
    ...
    path('apitestcase/getTableData/', views_interface.loadInterface),
    ...
    path('periodictask/run/<str:suit_id>', views_periodictask.runPeriodictask),
    ...
    path('apitestreport/', views_interfacereport.apitestreport,name='apireport'),
    path('apitestreport/select_day/', views_interfacereport.select_day),
    path('apitestreport/select_time/', views_interfacereport.select_time),
    path('apitestreport/search/', views_interfacereport.reportsearch),
]